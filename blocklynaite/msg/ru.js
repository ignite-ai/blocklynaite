...
Blocklynaite.LOCALISED_TEXT = {
  ...
  /* Modals */
  noServerTitle: "Blocklynaite не запущен",
  noServerTitleBody: "<p>Чтобы воспользоваться всеми возможностями Blocklynaite, приложение Blocklynaite для рабочего стола должно быть запущено на пользовательском компьютере.</p>" +
                     "<p>Если вы используете онлайн версию, вы не сможете изменять настройки а также загружать код в Arduino.</p>" +
                     "<p>Инструкции по установке можно найти на <a href=\"https://github.com/carlosperate/Blocklynaite\">Blocklynaite repository</a>.</p>" +
                     "<p>Если Blocklynaite уже установлен, убедитесь что приложение работает корректно.</p>",
  noServerNoLangBody: "Если приложение Blocklynaite не запущено, язык не может быть изменен.",
